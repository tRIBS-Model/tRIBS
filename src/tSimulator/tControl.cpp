...
#include "tribsVersion.h" // generated by CMake into the build tree
...
{  
	...
	Cout <<"\n\ntRIBS Version "<< TRIBS_VERSION <<", "<< TRIBS_RELEASE;
#ifdef TRIBS_GIT_SHA
	Cout <<"  [build "<< TRIBS_GIT_SHA <<"]";  // omitted when built without git
#endif
	Cout <<endl<<endl;
